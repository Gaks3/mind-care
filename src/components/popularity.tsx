        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          <div className="lg:w-[45%]">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight text-primary">
              Layanan kesehatan mental terbesar di dunia.{" "}
              100% online.
            </h2>
          </div>
          ...
          <div className="lg:w-[55%]">
            {stats.map((item, i) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-primary mb-1">{item.data}</h3>
                  <p className="text-gray-600 dark:text-gray-300">{item.proof}</p>
                </div>
              </div>
            ))}
          </div>
