...
const VisiMisiAbout = () => {
  return (
    <div className="px-4 sm:px-6 md:px-8 xl:px-16 2xl:px-52 mb-14 lg:h-screen lg:gap-0">
      <div className="md:w-[644px] w-full border-2 h-fit lg:h-52 rounded-lg p-6 bg-gradient-to-br from-primary to-blue-400 lg:mb-0 mb-4">
      ...
      <div className="md:w-[644px] w-full border-2 h-fit lg:h-52 lg:-mt-12 lg:ml-auto rounded-lg p-6 bg-white border-black/40">
