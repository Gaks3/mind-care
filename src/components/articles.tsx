  ...
  return (
    <section className="container mx-auto py-16 px-4">
      <div className="mb-12 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-primary mb-3">Artikel Menarik</h2>
        <p className="text-gray-600 max-w-2xl mx-auto">Temukan informasi bermanfaat mengenai kesehatan mental dan tips untuk menjalani kehidupan yang lebih sehat.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {articles.map((article) => (
          <Card key={article.id} className="overflow-hidden border-none rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col">
            ...
            <CardHeader className="pb-0 pt-5">
              <p className="text-base text-gray-600 mt-2 flex items-center gap-2">
                <CalendarPlus className="w-4 h-4 inline" />{article.createdAt}
              </p>
            ...
            <CardFooter className="mt-auto pt-2">
              <a href="#" className="text-blue-600 text-sm font-semibold flex items-center group hover:text-blue-800 transition-colors">
                Baca Selengkapnya
